...
export const Biscuit = ({ title, caption, intro}) => (
  <section className="section section-biscuit section-biscuit-layout">
    <div className="flex-row">
      <h2 className="profile-heading" data-testid='biscuit-heading'>{title}</h2>
      <p className="profile-caption" data-testid='biscuit-caption'>{caption}</p>
      <p className="profile-intro" data-testid='biscuit-intro'>{intro}</p>
    </div>
